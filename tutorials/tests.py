...
# test create Tutorial in database
# must use the mark.django_db marker for db access
"""
...
# test using a fixture, then we can reuse to test select, update...
# here the db parameter tells pytest that it will be database access
